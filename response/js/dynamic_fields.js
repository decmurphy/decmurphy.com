...
// For the IFCCs....
// This disables the 'Value' input when gravity turn or reverse gravity turn is selected.
// Don't touch!!! Although it's very dependent on how the html is built.
$(function () {
    $("select").change(function () {
        ...
        switch ($(this).val()) {
            default:
                val_id.prop('disabled', false);
                break;
            case "RGT":
            case "FGT":
                val_id.prop('disabled', true);
                break;
        }
